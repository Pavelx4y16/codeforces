...
class ComponentIds(Enum):
    ...
    UPDATE_CONTESTS_PROGRESS_BAR = "update_student_contests_progress_bar"
    UPDATE_CONTESTS_CONFIRM_DIALOG = "update_student_contests_confirm_dialog"
    UPDATE_CONTESTS_INTERVAL = "update_student_contests_interval"
